...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="${cp}/resources/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="${cp}/resources/plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="${cp}/resources/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  ...
  <link rel="stylesheet" href="${cp}/resources/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<script src="${cp}/resources/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
<script src="${cp}/resources/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="${cp}/resources/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="${cp}/resources/dist/js/pages/dashboard.js"></script>
