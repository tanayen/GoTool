                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${cp}/resources/dist/img/user2-160x160.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${cp}/resources/dist/img/user3-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${cp}/resources/dist/img/user4-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <small class="label pull-right bg-red">5</small>
                ...
                <li><a href="${cp}/resources/documentation/index.html"><i class="fa fa-book"></i>
...
<!-- page script -->
<script src="${cp}/resources/pagejs/tbpayment.js"></script>
<script>
    $(function () {
